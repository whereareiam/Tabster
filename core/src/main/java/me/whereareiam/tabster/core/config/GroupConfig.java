...
public class GroupConfig extends YamlSerializable {
	...
	@Comment(
			value = {
					...
					@CommentValue("      Command option allows you to specify the command and its subcommands."),
					@CommentValue("      You can use here wildcards like * and -. The - symbol is used to specify"),
					@CommentValue("      the limit of the command's subcommands."),
					@CommentValue("      - command: \"version\""),
					@CommentValue("        In type you have to specify how the command will be filtered."),
					@CommentValue("        Available values:"),
					@CommentValue("          - BLACKLIST  : blocks the command"),
					@CommentValue("          - WHITELIST  : allows the command"),
					...
					@CommentValue("      You can specify only the command and not its subcommands."),
					@CommentValue("      - command: \"version\""),
					@CommentValue("        In type you have to specify how the command completion will be filtered."),
					@CommentValue("        Available values:"),
					...
					@CommentValue(type = CommentValue.Type.TEXT),
					@CommentValue("      This text is displayed in a message that indicates where the command can be used."),
					@CommentValue("      request: \"Player\""),
					@CommentValue(type = CommentValue.Type.TEXT),
					@CommentValue("    messages:"),
					@CommentValue("      Here you can specify the messages that will be displayed when the command is blocked."),
					@CommentValue("      command-blocked: \"<gold>ᴛᴀʙsᴛᴇʀ <dark_gray>| <white>Command <red>/{command}</red> is not allowed\""),
					@CommentValue(type = CommentValue.Type.TEXT),
